...
A web-based event management system developed to support the registration, feedback, and e-certificate process for Technika Fest 2026.

## Overview

Technika Fest 2026 was developed to simplify several administrative processes involved in managing an event.

Instead of handling participant data, feedback, and certificates separately, the system brings these processes into a single web-based platform.
...
I contributed to the development of the system, with a focus on the technical implementation of the web application.
